...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_SLSH_PIPE] = ACTION_TAP_DANCE_DOUBLE(KC_SLSH, LSFT(KC_SLSH))
 ...
 */
 ...
 [_QW] = { /* QWERTY */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    TD(TD_MINS_UNDERS), KC_GRV,  TD(TD_EQL_PLUS),  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC  },
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    TD(TD_LSQBRACKET_LBRACKET), KC_BSLS, TD(TD_RSQBRACKET_RBRACKET), KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT  },
  { KC_F12,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_END,  KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL,  KC_UP,   KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  TD(TD_SLSH_PIPE), KC_RSFT  },
