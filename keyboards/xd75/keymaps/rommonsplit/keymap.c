 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    TD(TD_LSQBRACKET_LBRACKET), TD(TD_BSLASH_PIPE), TD(TD_RSQBRACKET_RBRACKET), KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ENT },
  { KC_F12,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_END,  KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, TD(TD_SQUOT_DQUOT)   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL,  KC_UP,   KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT  },
